...
((SELECT plat.id_plat FROM plat WHERE plat.nom_plat = 'Salade Niçoise'), (SELECT commande.id_commande FROM commande WHERE commande.date_commande = '2023-09-22' AND commande.id_client = (SELECT client.id_client FROM client WHERE client.email = 'julien.bernard@example.com')), 1),
